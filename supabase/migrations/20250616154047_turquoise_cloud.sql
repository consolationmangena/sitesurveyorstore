/*
  # Seed Initial Data for SiteSurveyor

  1. Categories
    - Insert application categories
  
  2. Applications
    - Insert sample applications from existing JSON data
...
BEGIN
  ...
  INSERT INTO applications (
    name, description, category_id, app_type, price, version, author, 
